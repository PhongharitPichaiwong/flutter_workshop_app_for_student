...
class _NotificationPageState extends State<NotificationPage> {
  ...
  // _showNotification, _showNotificationWithNoTitle, _showNotificationWithNoBody, _showNotificationCustomSound
...
Future<void> _showLinuxNotificationWithByteDataIcon() async {
  ...
  final image.Image? iconData = image.decodePng(
    assetIcon.buffer.asUint8List().toList() as Uint8List,
  );
